...
__decorate([
    (0, typeorm_1.ManyToOne)(() => policy_entity_1.Policy, (policy) => policy.claims, { onDelete: 'CASCADE' }),
    __metadata("design:type", policy_entity_1.Policy)
], Claim.prototype, "policy", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.claims, { onDelete: 'CASCADE' }),
    __metadata("design:type", user_entity_1.User)
], Claim.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'decimal', precision: 10, scale: 2 }),
    __metadata("design:type", Number)
], Claim.prototype, "claimAmt", void 0);
__decorate([
